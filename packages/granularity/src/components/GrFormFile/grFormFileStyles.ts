 ...
 *
 * Квадрат с `object-cover`: файлы приходят любых пропорций, а строки списка
 * обязаны остаться одной высоты.
 */
...
export const previewBaseClass = 'shrink-0 rounded-[var(--gr-radius-sm)] object-cover border border-[var(--gr-brd)]'

...
import {
  ...
  DEFAULT_DS_DIALOG_FOOTER_CONFIG,
...
export const dsDialogSafelist = [...new Set([
  ...configTokens(DEFAULT_DS_DIALOG_HEADER_CONFIG),
  ...configTokens(DEFAULT_DS_DIALOG_FOOTER_CONFIG),
  ...configTokens(DEFAULT_DS_DIALOG_BODY_CONFIG),
])]

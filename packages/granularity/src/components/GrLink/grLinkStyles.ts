...
export const variantClassByVariant: Record<GrLinkVariant, string> = {
  primary:
...
export function grLinkClass(options: { size: GrLinkSize, underline: GrLinkUnderline, variant: GrLinkVariant, disabled: boolean }): string {
  return [

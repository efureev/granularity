...
export type DsTableDensity = 'compact' | 'regular'

export interface DsTableProps {
  /**
   * Плотность таблицы — влияет на базовый размер шрифта.
   * Паддинги ячеек оставлены за консьюмером (DsTable — «тонкий» контейнер).
   */
...
/**
 * `DsTable` — «тонкий» DS-контейнер для табличных данных.
 *

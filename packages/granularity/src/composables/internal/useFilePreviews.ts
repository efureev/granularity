...
/**
 * Ключи списка и миниатюры превью. Общий на файловые компоненты пакета:
 * `GrFileUpload` (отправка) и `GrFormFile` (поле формы) показывают один и тот
 * же набор одинаково, и правила «что считать картинкой» у них обязаны совпадать.
 *

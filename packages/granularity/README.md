...
| --- | ---: | ---: |
| the whole package from the root | 672.2 kB | 100 % |
...
| [`@feugene/granularity-editor`](../granularity-editor) | 0.4.1 | Rich-text editing: a TipTap-backed GrRichText field with a design-system toolbar. |

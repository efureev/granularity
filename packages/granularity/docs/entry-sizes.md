...
> Сгенерировано `yarn sizes:docs` по собранному `dist` пакета `@feugene/granularity` 0.48.0.
...
**Складывать эти числа нельзя.** Общий чанк посчитан в каждой строке заново, а платится один раз: сумма 5 самых тяжёлых строк даёт 397.9 kB, а вместе они весят 178.4 kB. Вес набора считается объединением — так его и считает `yarn sizes`.
...
| `GrPagination` | 79.3 kB | 47 | 13 % |
| `GrTreeSelect` | 75.8 kB | 45 | 12 % |
| `GrSelect` | 70.6 kB | 43 | 11 % |
| `GrColorPicker` | 66.6 kB | 37 | 11 % |
| `GrJsonViewer` | 63.0 kB | 38 | 10 % |
| `GrDataTable` | 59.8 kB | 36 | 10 % |
| `GrTransfer` | 59.4 kB | 38 | 10 % |
| `GrAutocomplete` | 57.8 kB | 37 | 9 % |
...
| `GrTabs` | 16.4 kB | 12 | 3 % |
| `GrChip` | 16.4 kB | 13 | 3 % |
| `GrSlider` | 15.4 kB | 13 | 2 % |
| `GrNavbar` | 15.4 kB | 14 | 2 % |

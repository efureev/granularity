...
Высота вкладки повторяет шкалу [`GrButton`](./GrButton.md) — 28 / 32 / 40 / 44 px
...
Продолжение за краем выдаёт **затухание**: гаснет тот край, за которым ещё есть
вкладки — в начале ряда правый, в конце левый, в середине оба. Влезает
целиком — не гаснет вовсе. Без этого признака вкладки за краем оставались
достижимыми, но узнать, что они там есть, было нечем.

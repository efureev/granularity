...
между колонками не рвётся. Лестница брейкпоинтов зашита в саму ступень — четыре
колонки коротких пар на узком экране нечитаемы, поэтому `columns: 4` это «до
четырёх»: одна колонка на телефоне, две на планшете, четыре на широком экране.

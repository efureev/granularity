...
| Нужно | Берите |
| --- | --- |
| Границу двигает пользователь | [`GrSplitter`](./GrSplitter.md) |
| Разделяются разделы с заголовками | [`GrFormSection`](./GrFormSection.md) |
| Разделяются пункты меню | [`GrDropdownMenu`](./GrDropdownMenu.md) с `dividers` |
| Разделяются строки списка | [`GrList`](./GrList.md) с `divided` |

...
| Содержимое привязано к кнопке | [`GrPopover`](./GrPopover.md) |
| Постоянная боковая навигация, а не выезжающая | [`GrSidebar`](./GrSidebar.md) |
...
каком порядке компоненты смонтированы ([`../z-index.md`](../z-index.md)).

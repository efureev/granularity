 ...
 *
 * Композит использует примитивы из `@feugene/granularity` (GrFormField,
 * GrInput, GrButton) — они перечислены в `dependencies` в квалифицированной
...
export const xgQuickFormConfig = defineGranularComponent(import.meta.url, {
    name: 'XgQuickForm',
    dependencies: [
        {provider: '@feugene/granularity', components: ['GrFormField', 'GrInput', 'GrButton']}
    ],
})

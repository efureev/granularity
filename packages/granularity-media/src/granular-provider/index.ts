// Browser-entry granular-provider'а `@feugene/granularity-media`.
//
...
export const granularityMediaProvider = createGranularityMediaProvider(granularityProvider, packageBaseUrl)

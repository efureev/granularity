 ...
 * монорепо — и там `tsconfig.json` другой: каждый файл пакета падает с
 * `Parsing error: Could not read Project Service default project`, а гейт при
 * этом зелёный, потому что `yarn lint` идёт из пакета.
 */

 ...
 *
 * Блок — свой (`grCharts`), а не `gr` ядра: чужой блок companion-пакету брать
 * нельзя, иначе словари столкнутся на первом же совпавшем верхнем ключе. Ключи
 * компонентов выглядят как `grCharts.chart.empty`.
 *
 * ```ts
 * import { en, ru, GR_CHARTS_I18N_BLOCK } from '@feugene/granularity-charts/i18n'
 ...
 * `@feugene/granularity-charts/i18n/all`.
 */
export { GR_CHARTS_I18N_BLOCK } from './const'
export { en } from './en'
export { es } from './es'
export { ru } from './ru'

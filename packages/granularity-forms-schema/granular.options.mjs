...
import granularityFormsSchemaProvider from './dist/granular-provider.js'

export default {
  providers: [granularityFormsSchemaProvider],
  components: [{ provider: '@feugene/granularity-forms-schema', names: 'all' }],
}

...
import granularityChronoProvider from './dist/granular-provider.js'

export default {
  providers: [granularityChronoProvider],
  components: [{ provider: '@feugene/granularity-chrono', names: 'all' }],
}

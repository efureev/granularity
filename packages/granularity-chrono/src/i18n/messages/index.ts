 ...
 * компонентов выглядят как `grChrono.calendar.previousMonth`.
 *
 * ```ts
 * import { en, ru, GR_CHRONO_I18N_BLOCK } from '@feugene/granularity-chrono/i18n'
 ...
 * `@feugene/granularity-chrono/i18n/all`.
 */
export { GR_CHRONO_I18N_BLOCK } from './const'
export { en } from './en'
export { es } from './es'
export { ru } from './ru'

 ...
 */
const SERVICES = [
  'api-gateway', 'auth', 'billing', 'cart', 'catalog', 'checkout',
  'cms', 'delivery', 'email', 'events', 'exports', 'payments',
  'feed', 'files', 'geo', 'identity', 'images', 'imports',
  'inventory', 'invoices', 'loyalty', 'media', 'notify', 'orders',
  'pricing', 'search', 'sessions', 'shipping', 'support', 'webhooks',
]

    ...
    components: [
      {
        ...
        overview: {
          ...
          features: [
            ...
            'Рамка принимает соотношение самого потока, а нужное приложению задаётся пропом: кадр срезается по центру ровно так, как показывало превью.',
        ...
        apiSections: [
          {
            ...
            items: [
              ...
              { name: 'aspectRatio', type: 'number', description: 'Соотношение сторон рамки и снимка. Без него рамка принимает соотношение самого потока: камеры отдают то 4:3, то 16:9. Лишнее срезается по центру.' },

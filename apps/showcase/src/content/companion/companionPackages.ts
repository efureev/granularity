  ...
  return [
    {
      ...
      items: [
        ...
        { name: 'zoom', type: `false | 'brush' | 'wheel' | 'both'`, default: 'false', description: 'Какими жестами пользователь меняет видимое окно: протяжкой по холсту, колесом или обоими. Клавиатурного пути к окну нет — доступное управление им ставит приложение через `v-model:xWindow`.' },
      ...
      },
      {
        ...
        examples: [
          ...
          },
          {
            ...
            note: 'Окно выбирает **данные**, а не обрезает рисунок: по нему идут курсор, клавиатура, скрытая таблица и размах оси значений. Клавиатурного пути к окну у графика нет — поэтому оно выведено наружу как `v-model:xWindow`, и доступное управление им ставит приложение. Кнопка сброса в примере — это оно и есть.',
          },
          {

 ...
 * открыв ссылку. Пока пакетов было ноль-один, столкнуться было негде; с двумя
 * companion-пакетами одноимённые компоненты — норма (`GrDatePicker` есть и в
 * `granularity-datepicker`, и в `granularity-chrono`).
 */

...
const componentSummaryOverrides = {
  ...
  GrContextMenu: 'Brings actions to the pointer: right-click a row, a tree node or a canvas.',
  ...
  GrOtpInput: 'A field for a code of known length: an SMS confirmation, a one-time password, a PIN.',
  ...
  GrTreeSections: 'A tree whose top level becomes a section heading instead of a node.',

...
export const grSidebarExamples: ShowcaseComponentExampleDoc[] = [
  {
    ...
    description: 'Базовый сценарий для desktop-shell: `GrSidebar` хранит группу section actions и остаётся визуальной рамкой для левой навигации.',
    status: 'ready',
    previewKey: 'ds-sidebar-basic-sections',
    code: `<script setup lang="ts">
import { ref } from 'vue'

import { GrButton, GrSidebar } from '@feugene/granularity'
...
<template>
  <GrSidebar title="Workspace" subtitle="Navigation">
  ...
  },
  {
    ...
    code: `<script setup lang="ts">
import { GrSidebar } from '@feugene/granularity'
</script>
...
import { GrSidebar, GrSwitch } from '@feugene/granularity'

...
<template>
  <DsButton size="sm" @click="push({ title: 'Saved', variant: 'success' })">
    Push success toast
  </DsButton>
...
<template>
  <DsButton size="sm" variant="outline" @click="push({ title: 'Manual follow-up required', variant: 'warning', timeoutMs: 0 })">
    Open sticky toast
  </DsButton>
  <DsButton size="sm" variant="ghost" @click="clear()">
    Clear store
  </DsButton>
...
<template>
  <DsButton size="sm" @click="queueWorkflowToasts">

...
export const dsSelectExamples: ShowcaseComponentExampleDoc[] = [
  {
    id: 'select-native-modes',
    title: 'Native single and clearable',
    description: 'Базовый сценарий для `DsSelect`: обычный single-select и clearable режим в native-rendering без дополнительной composition-логики.',
    status: 'ready',
    previewKey: 'ds-select-native-modes',
    code: `<script setup lang="ts">
import { ref } from 'vue'

import { DsSelect } from '@feugene/granularity'
...
import { DsBadge, DsSelect } from '@feugene/granularity'

...
export const grKbdExamples: ShowcaseComponentExampleDoc[] = [
  ...
  {
    id: 'kbd-sequence',
    title: 'Последовательность одной строкой',
    description: 'Пробел делит строку на шаги, плюс — клавиши внутри шага: `g i` это «G затем I», `mod+k p` — «⌘K затем P». Ту же строку понимает `v-hotkey`, поэтому подсказка и привязка описываются одним значением и разойтись не могут.',
    status: 'ready',
    previewKey: 'gr-kbd-sequence',
  },
  {
    id: 'kbd-variants',

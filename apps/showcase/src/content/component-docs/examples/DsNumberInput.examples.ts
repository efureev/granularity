...
export const dsNumberInputExamples: ShowcaseComponentExampleDoc[] = [
  {
...
import { DsFormField, DsNumberInput } from '@feugene/granularity'
...
<template>
  <div class="grid gap-4 lg:grid-cols-2">
    ...
    <DsFormField label="Horizontal controls">
      <DsNumberInput
        v-model="quantity"
        controls
...
<template>
  <div class="grid gap-4 lg:grid-cols-2">
    <DsFormField label="Comma decimal separator">
      <DsNumberInput
        v-model="amountComma"
        decimal-separator=","
        :precision="2"
    ...
    <DsFormField label="Range guards">
      <DsNumberInput
        v-model="percentage"
        decimal-separator=","
        :min="0"
...
import { DsNumberInput, DsRadioGroup } from '@feugene/granularity'

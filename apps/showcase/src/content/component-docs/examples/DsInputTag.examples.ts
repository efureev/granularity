...
export const dsInputTagExamples: ShowcaseComponentExampleDoc[] = [
  {
...
import { DsInputTag } from '@feugene/granularity'
...
import { DsBadge, DsInputTag } from '@feugene/granularity'

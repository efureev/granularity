...
const previewRegistry = {
  ...
  'gr-autocomplete-virtual': defineAsyncComponent(() => import('../demos/components/gr-autocomplete/GrAutocompleteVirtualDemo.vue')),
  ...
  'gr-breadcrumbs-basic': defineAsyncComponent(() => import('../demos/components/gr-breadcrumbs/GrBreadcrumbsBasicDemo.vue')),
  'gr-breadcrumbs-collapsed': defineAsyncComponent(() => import('../demos/components/gr-breadcrumbs/GrBreadcrumbsCollapsedDemo.vue')),
  'gr-breadcrumbs-icons': defineAsyncComponent(() => import('../demos/components/gr-breadcrumbs/GrBreadcrumbsIconsDemo.vue')),
  ...
  'gr-button-group-shared-style': defineAsyncComponent(() => import('../demos/components/gr-button-group/GrButtonGroupSharedStyleDemo.vue')),
  'gr-button-group-orientation': defineAsyncComponent(() => import('../demos/components/gr-button-group/GrButtonGroupOrientationDemo.vue')),
  ...
  'gr-checkbox-group-basic': defineAsyncComponent(() => import('../demos/components/gr-checkbox-group/GrCheckboxGroupBasicDemo.vue')),
  'gr-checkbox-group-form': defineAsyncComponent(() => import('../demos/components/gr-checkbox-group/GrCheckboxGroupFormDemo.vue')),
  'gr-collapse-accordion-flow': defineAsyncComponent(() => import('../demos/components/gr-collapse/GrCollapseAccordionDemo.vue')),
  'gr-collapse-borderless': defineAsyncComponent(() => import('../demos/components/gr-collapse/GrCollapseBorderlessDemo.vue')),
  'gr-collapse-guard': defineAsyncComponent(() => import('../demos/components/gr-collapse/GrCollapseGuardDemo.vue')),
  ...
  'gr-command-palette-virtual': defineAsyncComponent(() => import('../demos/components/gr-command-palette/GrCommandPaletteVirtualDemo.vue')),
  ...
  'gr-confirm-dialog-async-confirm': defineAsyncComponent(() => import('../demos/components/gr-confirm-dialog/GrConfirmDialogAsyncConfirmDemo.vue')),
  ...
  'gr-dropdown-menu-declarative': defineAsyncComponent(() => import('../demos/components/gr-dropdown-menu/GrDropdownMenuDeclarativeDemo.vue')),
  'gr-drawer-bottom-sheet': defineAsyncComponent(() => import('../demos/components/gr-drawer/GrDrawerBottomSheetDemo.vue')),
  'gr-drawer-custom-header': defineAsyncComponent(() => import('../demos/components/gr-drawer/GrDrawerCustomHeaderDemo.vue')),
  'gr-drawer-filter-panel': defineAsyncComponent(() => import('../demos/components/gr-drawer/GrDrawerFilterPanelDemo.vue')),
  'gr-drawer-non-modal': defineAsyncComponent(() => import('../demos/components/gr-drawer/GrDrawerNonModalDemo.vue')),
  ...
  'gr-icon-semantics': defineAsyncComponent(() => import('../demos/components/gr-icon/GrIconSemanticsDemo.vue')),
  ...
  'gr-input-enhancements': defineAsyncComponent(() => import('../demos/components/gr-input/GrInputEnhancementsDemo.vue')),
  ...
  'gr-number-input-grouping': defineAsyncComponent(() => import('../demos/components/gr-number-input/GrNumberInputGroupingDemo.vue')),
  ...
  'gr-pagination-compact-jumper': defineAsyncComponent(() => import('../demos/components/gr-pagination/GrPaginationCompactJumperDemo.vue')),
  'gr-pagination-sizes': defineAsyncComponent(() => import('../demos/components/gr-pagination/GrPaginationSizesDemo.vue')),
  'gr-popover-confirm': defineAsyncComponent(() => import('../demos/components/gr-popover/GrPopoverConfirmDemo.vue')),
  'gr-popover-form': defineAsyncComponent(() => import('../demos/components/gr-popover/GrPopoverFormDemo.vue')),
  'gr-popover-placement': defineAsyncComponent(() => import('../demos/components/gr-popover/GrPopoverPlacementDemo.vue')),
  ...
  'gr-progress-bar-sizes': defineAsyncComponent(() => import('../demos/components/gr-progress-bar/GrProgressBarSizesDemo.vue')),
  ...
  'gr-prompt-dialog-multiline-rules': defineAsyncComponent(() => import('../demos/components/gr-prompt-dialog/GrPromptDialogMultilineRulesDemo.vue')),
  ...
  'gr-select-remote-search': defineAsyncComponent(() => import('../demos/components/gr-select/GrSelectRemoteSearchDemo.vue')),
  'gr-select-virtual': defineAsyncComponent(() => import('../demos/components/gr-select/GrSelectVirtualDemo.vue')),
  ...
  'gr-select-filter-loading-tags': defineAsyncComponent(() => import('../demos/components/gr-select/GrSelectFilterLoadingTagsDemo.vue')),
  ...
  'gr-statistic-basic': defineAsyncComponent(() => import('../demos/components/gr-statistic/GrStatisticBasicDemo.vue')),
  'gr-statistic-trend': defineAsyncComponent(() => import('../demos/components/gr-statistic/GrStatisticTrendDemo.vue')),
  'gr-statistic-slots': defineAsyncComponent(() => import('../demos/components/gr-statistic/GrStatisticSlotsDemo.vue')),
  ...
  'gr-table-sizes': defineAsyncComponent(() => import('../demos/components/gr-table/GrTableSizesDemo.vue')),
  'gr-rating-basic': defineAsyncComponent(() => import('../demos/components/gr-rating/GrRatingBasicDemo.vue')),
  ...
  'gr-tabs-activation': defineAsyncComponent(() => import('../demos/components/gr-tabs/GrTabsActivationDemo.vue')),
  ...
  'gr-tabs-sizes': defineAsyncComponent(() => import('../demos/components/gr-tabs/GrTabsSizesDemo.vue')),
  'gr-textarea-autosize': defineAsyncComponent(() => import('../demos/components/gr-textarea/GrTextareaAutosizeDemo.vue')),
  ...
  'gr-textarea-sizes': defineAsyncComponent(() => import('../demos/components/gr-textarea/GrTextareaSizesDemo.vue')),
  ...
  'gr-tree-checkboxes': defineAsyncComponent(() => import('../demos/components/gr-tree/GrTreeCheckboxesDemo.vue')),
  'gr-tree-lazy': defineAsyncComponent(() => import('../demos/components/gr-tree/GrTreeLazyDemo.vue')),
  'gr-tree-keyboard': defineAsyncComponent(() => import('../demos/components/gr-tree/GrTreeKeyboardDemo.vue')),
  'gr-tree-virtual': defineAsyncComponent(() => import('../demos/components/gr-tree/GrTreeVirtualDemo.vue')),

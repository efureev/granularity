...
const previewRegistry = {
  ...
  'ds-confirm-dialog-service-link': defineAsyncComponent(() => import('../demos/components/ds-confirm-dialog/GrDialogServiceLinkDemo.vue')),
  ...
  'ds-file-upload-action-xhr': defineAsyncComponent(() => import('../demos/components/ds-file-upload/GrFileUploadActionXhrDemo.vue')),
  ...
  'ds-file-upload-progress': defineAsyncComponent(() => import('../demos/components/ds-file-upload/GrFileUploadProgressDemo.vue')),
  'ds-file-upload-progress-slot': defineAsyncComponent(() => import('../demos/components/ds-file-upload/GrFileUploadProgressSlotDemo.vue')),
  ...
  'ds-input-addons-basic': defineAsyncComponent(() => import('../demos/components/ds-input/GrInputAddonsDemo.vue')),
  'ds-input-addon-slots': defineAsyncComponent(() => import('../demos/components/ds-input/GrInputAddonSlotsDemo.vue')),
  ...
  'ds-prompt-dialog-service-link': defineAsyncComponent(() => import('../demos/components/ds-confirm-dialog/GrDialogServiceLinkDemo.vue')),
  ...
  'ds-select-groups': defineAsyncComponent(() => import('../demos/components/ds-select/GrSelectGroupsDemo.vue')),
  ...
  'ds-response-error-banner-form': defineAsyncComponent(() => import('../demos/components/ds-response-error-banner/GrFormErrorBannerDemo.vue')),
  'ds-response-error-banner-kind-filter': defineAsyncComponent(() => import('../demos/components/ds-response-error-banner/GrResponseErrorBannerKindFilterDemo.vue')),
  'ds-response-error-banner-presets': defineAsyncComponent(() => import('../demos/components/ds-response-error-banner/GrResponseErrorBannerPresetsDemo.vue')),
  'ds-response-error-banner-upload': defineAsyncComponent(() => import('../demos/components/ds-response-error-banner/GrUploadErrorBannerDemo.vue')),

...
- [`@feugene/granularity-code`](./packages/granularity-code/README.md) `0.1.0` — Code surfaces for @feugene/granularity: view, edit and diff — the viewer and the diff carry no dependencies at all.
